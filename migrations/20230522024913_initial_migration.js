...
exports.up = async function (knex) {
  ...
  await knexHelper.createTable('restaurants', function restaurants(table) {
    table.increments('id')
  ...
  await knexHelper.createTable('products', function products(table) {
    ...
    table.integer('restaurant_id')
      .references('id')
      .inTable(this.getTableReferenceWithSchema('restaurants', SCHEMA))
      .notNullable()
    table.timestamps(true, true)
  }, SCHEMA)
}
...
exports.down = async function (knex) {
  ...
  await knex.schema.withSchema(SCHEMA).dropTable('restaurants')
